<?php
    ...
    $sql = "SELECT *  FROM tbl_login WHERE login_type<>'admin' ORDER BY login_id DESC";
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <?php if($_SESSION['type'] == "admin"){?>
                                        <button type="button" class="btn btn-primary mbtn" onclick="location.href='profil.php';">
                                        ...
                                        <tbody>
                                            <?php $i = "1";
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $row['login_mobile'];?></td>
                                                    <td><?php echo $row['login_email'];?></td>
                                                    <td><?php echo $row['login_type'];?></td>
                                                    <td><?php echo $row['login_status'];?></td>
                                                    <td>
                                                        <a class="edit_data" href="profile.php?id=<?php echo $row["login_id"]; ?>">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" name="candidate_cv" id="candidate_cv" placeholder="Enter Candidate CV" required />
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <label id="candidate_cv_name"></label>
