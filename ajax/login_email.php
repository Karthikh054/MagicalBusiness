<?php
    ...
    $sql = "SELECT * FROM tbl_login WHERE (login_status='Active') AND (login_email='".$email."')";
    $result = mysqli_query($conn, $sql);
    if (mysqli_num_rows($result) > 0)
    {
        $fourRandomDigit = rand(1000,9999);
        $sql_update = "UPDATE tbl_login SET login_password='".$fourRandomDigit."' WHERE login_email='".$email."'";
        $result = mysqli_query($conn, $sql_update);
        
        // $to = $email;
        // $subject = "New Password";
         
        // $message = "<b>The New Password is .$fourRandomDigit.: </b>";
        ...
        //         <link href='https://fots.googleapis.com/css?family=Asap:400,400italic,700,700italic' rel='stylesheet' type='text/css'>
        //         <style type='text/css'>
        ...
        //     <body style='-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #fed149; height: 100%; margin: 0; padding: 0; width: 100%'>
        //         <center>
        //             <table align='center' border='0' cellpadding='0' cellspacing='0' height='100%' id='bodyTable' style='border-collapse: collapse; mso-table-lspace: 0;mso-table-rspace: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust:100%; background-color: #fed149; height: 100%; margin: 0; padding: 0; width:100%' width='100%'>
        //                 <tr>
        ...
        //                         <table border='0' cellpadding='0' cellspacing='0' class='templateContainer' style='border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0;-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; max-width:600px; border: 0;margin-top: 85px;' width='100%'>
        //                             <tr>
        ...
        //                                                                     <img align='center' alt='New Password' class='mcnImage' src='https://static.lingoapp.com/assets/images/email/il-password-reset@2x.png' style='-ms-interpolation-mode: bicubic; border: 0; height: auto; outline: none;text-decoration: none; vertical-align: bottom; max-width:1200px; padding-bottom:0; display: inline !important; vertical-align: bottom;' width='600'></img>
        //                                                                 </td>
        //                                                             </tr>
        //                                                         </tbody>
        //                                                     </table>
        ...
        //                                                                     <h1 class='null' style='color: #2a2a2a; font-family: 'Asap', Helvetica,sans-serif; font-size: 32px; font-style: normal; font-weight: bold; line-height:125%; letter-spacing: 2px; text-align: center; display: block; margin: 0;padding: 0'>
        //                                                                         <span style='text-transform:uppercase'>Your</span>
        //                                                                     </h1>
        ...
        //                                                                         <span style='text-transform:uppercase'>New password</span>
        //                                                                     </h2>
        //                                                                 </td>
        //                                                             </tr>
        //                                                         </tbody>
